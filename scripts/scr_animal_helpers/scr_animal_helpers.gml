...
function effect_play_soundwave(_actor_object) {
    _actor_object.vfx_type = "soundwave";
    _actor_object.vfx_particles = [];
    _actor_object.vfx_timer = 60;
}

// --- NEW: FEATHERS (Wing Smack) ---
function effect_play_feathers(_actor_object) {
    _actor_object.vfx_type = "feathers";
    _actor_object.vfx_particles = [];
    _actor_object.vfx_timer = 45;
}
