...
switch (current_state) {
    ...
    case BATTLE_STATE.PLAYER_MOVE_RUN: 
        ...
        switch (_move.move_type) {
            ...
            case MOVE_TYPE.HEAL:
                player_critter_data.hp += _move.effect_power;
            ...
            case MOVE_TYPE.STAT_DEBUFF:
                if (_move.move_name == "Hiss") { 
                    ...
                    enemy_critter_data.def_stage -= 1;
                    enemy_critter_data.def_stage = clamp(enemy_critter_data.def_stage, -6, 6);
                    effect_play_stat_flash(enemy_actor, "debuff"); battle_log_text = enemy_critter_data.nickname + "'s defense fell!";
                }
                break;
    ...
    case BATTLE_STATE.ENEMY_MOVE_RUN:
        ...
        switch (_move.move_type) {
            case MOVE_TYPE.DAMAGE:
                ...
                var L = enemy_critter_data.level; var A = enemy_critter_data.atk * _atk_mult; var D = player_critter_data.defense * _def_mult;
                var P = _move.atk;
                var _damage = floor( ( ( ( (2 * L / 5) + 2 ) * P * (A / D) ) / 50 ) + 2 );
            ...
            case MOVE_TYPE.STAT_DEBUFF:
                 if (_move.move_name == "Hiss") {
                    ...
                    player_critter_data.def_stage -= 1;
                    player_critter_data.def_stage = clamp(player_critter_data.def_stage, -6, 6);
                    effect_play_stat_flash(player_actor, "debuff"); battle_log_text = player_critter_data.nickname + "'s defense fell!"; 
                }
                break;
            case MOVE_TYPE.STAT_BUFF:
                if (_move == global.MOVE_SYSTEM_CALL) {
