...
// We do this every frame so elements follow the window smoothly
// Note: window_x1/y1 are updated by the parent Step event first
...
switch (current_state) {
    ...
    case BATTLE_STATE.PLAYER_TURN:
        ...
        switch (current_menu) {
            ...
            case MENU.FIGHT:
                ...
                if (_key_enter) {
                    if (menu_focus == 3) { current_menu = MENU.MAIN; menu_focus = 0; }
    ...
    case BATTLE_STATE.WIN_END:
        ...
        if (mouse_check_button_pressed(mb_left) || keyboard_check_pressed(vk_enter)) {
            if (is_casual == false) { global.PlayerData.team[0] = player_critter_data; global.PlayerData.current_opponent_index++; } 
